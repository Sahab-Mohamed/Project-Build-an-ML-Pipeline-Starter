...
#define CONFIGURE_ARGS " '--prefix=/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev' '--with-libraries=/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/lib' '--with-includes=/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/include' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-ssl=openssl' '--with-uuid=e2fs' '--with-zstd' '--with-system-tzdata=/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/share/zoneinfo' '--with-liburing' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1766447388467/work=/usr/local/src/conda/postgresql-split-18.1 -fdebug-prefix-map=/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/lib -Wl,-rpath-link,/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/lib -L/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/include' 'CXX=' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1766447388467/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/home/sahab/Project-Build-an-ML-Pipeline-Starter/.conda_envs/nyc_airbnb_dev/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 18.1 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (conda-forge gcc 14.3.0-16) 14.3.0, 64-bit"
