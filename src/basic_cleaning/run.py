...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact",
        type=str,
        help="Name of the input W&B artifact containing the raw dataset",
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact",
        type=str,
        help="Name of the output W&B artifact to store the cleaned dataset",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price",
        type=float,
        help="Minimum rental price to keep in the dataset",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="Maximum rental price to keep in the dataset",
        required=True
    )
